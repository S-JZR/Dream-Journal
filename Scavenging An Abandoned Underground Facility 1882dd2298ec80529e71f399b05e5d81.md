...
As everything settled, we ventured deeper into the facility through a series of straight hallways until entering a central cave chamber with a pathway running alongside a river of lava illuminating the atmosphere. Amid the shadows behind shipment crates, we encountered multiple deranged cats infected with a zombie virus, tasked with eliminating them. However, as we neared completion, one pounced from behind, scratching my arms. Retreating to the hallway, I instinctively smeared sanitizing gel across the emerging welts, effectively averting the infection.

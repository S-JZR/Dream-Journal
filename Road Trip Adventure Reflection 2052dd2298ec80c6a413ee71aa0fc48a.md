...
- Progress in video games is an arbitrary construct.
- Investing excessive time to achieve everything is unproductive, especially as modern games get longer or if the platforms eventually shutdown and all data is lost.
- One could easily modify the code, execute commands to obtain any item, or watch others’ gameplay online who achieve everything.

...
Later, in an unrelated event, I found an RPG-7 and fired a round at a distant target from a window. The instructor took notice, saying, "Let's see if you can carry that weight," and told me to target an electrical box on the exterior of a one-storey brick building with pavement that appeared in the distance beyond the swamp. Not knowing which piece of equipment he meant, given there were a few, I randomly fired at one.
